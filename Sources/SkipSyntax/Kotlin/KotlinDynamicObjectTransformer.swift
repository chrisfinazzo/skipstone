...
public final class KotlinDynamicObjectTransformer: KotlinTransformer {
    ...
    private func generateDynamicClass(name: String, in namespace: String, generated: inout Set<String>, swift: inout [String]) {
        ...
        swift.append(2, "}")
        swift.append(2, "static func Companion(options: JConvertibleOptions = .kotlincompat) -> AnyDynamicObject {")
        swift.append(3, "return try! AnyDynamicObject(forStaticsOfClassName: \"\(className)\", options: options)")
        swift.append(2, "}")
        swift.append(1, "}")
        swift.append("}")
    }
